...
public class LavagemWS extends HttpServlet {
        ...
        switch (String.valueOf(acao)) {
            ...
            case "imprimir":
                if (request.getParameter("id") != null) {
                    ...
                    request.setAttribute("lavagem", this.buscaLavagem(idLav));
                    request.setAttribute("msg", this.listarr(idLav));
                    pagina = "compLavagem.jsp";
    ...
    private Lavagem buscaLavagem(Long id) {
        LavagemDAO dao = new LavagemDAO();
        Lavagem lavagem = dao.buscarPorChavePrimaria(id);
        dao.fecharConexao();
        return lavagem;
    }
    
    private List<Lavagem> listarr(Long id) {
        LavagemDAO dao = new LavagemDAO();
        Lavagem lavagem = dao.buscarPorChavePrimaria(id);
        dao.fecharConexao();
        List<Lavagem> l = new ArrayList<Lavagem>();
        l.add(lavagem);
        return l;
    }
