 ...
 * @author lucas
 */
@WebServlet(name = "TabelaPrecoWS", urlPatterns = {"/admin/tabelaPreco/TabelaPrecoWS"})
public class TabelaPrecoWS extends HttpServlet {

    private TabelaPrecoDAO dao;
    private TabelaPreco obj;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (String.valueOf(acao)) {
            ...
            case "edit":
                id = request.getParameter("id");
                dao = new TabelaPrecoDAO();
                TabelaPreco obj = dao.buscarPorChavePrimaria(Long.parseLong(id));
...
//                List<TabelaPreco> lista2 = this.listar(filtro);
...
//                break;
            ...
            default:
                ...
                if (request.getParameter("filtro") != null) {
                    try {
                        ...
                        Logger.getLogger(TabelaPrecoWS.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    lista = dao.listar();
                }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("txtOpcoes") == null) {
            ...
            if (request.getParameter("txtId") != null) {
                ...
                obj.setOpcoes(request.getParameter("txtOpcoes"));
