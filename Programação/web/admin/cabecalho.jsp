      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="../pagamento/PagamentoWS">
                <i class="nav-icon icon-cursor"></i> Pagamentos
              </a>
            ...
            <li class="nav-item ">
              <a class="nav-link" href="../admin/AdminWS">
                <i class="nav-icon icon-cursor"></i> Admin
              </a>
